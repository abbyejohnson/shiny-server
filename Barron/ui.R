...
ui = fluidPage(
    ...
    titlePanel(strong('Barron County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                fluidRow(
                  ...
                  column(3,
                         ...
                         selectInput("year", "Year",
                                     c("2022 & 2023 (Combined)" = "2022&2023",
                                       "2023 (Year 2)" = "2023", 
                                       "2022 (Year 1)" = "2022"), selected = "2022&2023")),
                  column(5,
                         selectInput("var", "Variable:",
                                     c("Nitrate-Nitrogen" = "Nitrate",
                                       ...
                                       "Soil Drainage Rank" = "weighted.rank"), selected = "Nitrate"))),
                hr(),
                fluidRow(
                  column(12, offset = 0,
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Barron County")),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Barron County is conducting a project to gather information on well water quality. 
                              The water quality data collected is intended to understand whether groundwater quality is changing over time."),
                              tags$ul
                                      (tags$li("2022 - 345 well owners participated in Year 1"),
                                      tags$li("2023 - 378 well owners participated in Year 2")
                                        ),
                              ...
                              The well network is intended to be representative of Barron County (i.e. accounting for 
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Alkalinity",
                                         ...
                                         p("Alkalinity is a measure of water's ability to neutralize acids.  Alkalinity is associated with carbonate 
                                          ...
                                          carbonate aquifers which occur in parts of Barron County."),
                                         br(),
                                         ...
                                         p("Because alkalinity is related to the rocks and soils that water flows through on its way to a 
                                          ...
                                          on well water quality on an individual well, or make sense of broader water quality results from Barron County. 
                                ...
                                tabPanel("Total Hardness",
                                         ...
                                         p("Water with a total hardness concentration less than 150 mg/L is considered soft.  Water with too little hardness
                                          ...
                                          plumbing system. Please note: Total Hardness values less than 50 would be rare for Barron County, if your water reported less than 50 mg/L of Total 
                                ...
                                tabPanel("Arsenic",
                                         ...
                                         p("Long term exposure to arsenic in drinking water can increase the likelihood of developing certain cancers suck as skin,
                                ...
                                tabPanel("Iron",
                                         ...
                                         p("Iron is a common element found in minerals, rocks and soil. It is naturally occurring in groundwater.
                                           Iron can cause taste problems and discoloration of water and clothing washed in it."),
                                         h4(strong("Why test for Iron")),
                                         p("There are no health concerns associated with iron for levels typically found in drinking water. Small amounts
                                           of iron can be removed by water softeners. Larger concentrations of iron may require special iron treatment."),
                                ),
                                tabPanel("Magnesium",
                                ...
                                tabPanel("Manganese",
                                         ...
                                         p("Manganese is a common element found in minerals, rocks and soil as a result it is naturally occurring in groundwater."),
                                         h4(strong("Why test for Manganese")),
                                         p("Manganese is part of a healthy diet, but can be harmful if consumed in excess. Some studies suggest manganese can
                                           have effects on learning and behavior in children. Also suspected to cause harm to the nervous system. Infants
                                           and people who drink more than 8 cups of water a day and have a liver disease are most at risk."),
                                ),
                                tabPanel("Potassium",
                                ...
                                tabPanel("Phosphorus",
                                         ...
                                         p("Phosphorus is naturally occurring at low levels in groundwater."),
                                         h4(strong("Why test for Phosphorus")),
                                         p("Elevated levels of Phosphorus concentrations may result from dissolution of phosphorus rich minerals."),
                                )
                              )),

...
server = function(input, output, session) {
  ...
  
  {
    if(input$year == "2022") {
      ...
      munidf <- munidf2        #[munidf$YEAR == 2022 | munidf$YEAR == 2023,]
    }
    ...
    #   
      ...
      mbreaks2 <- c(0, 0.001, 0.002, 0.003, 0.004, 0.005, 0.006)
      ...
      mbreaks1 <- c(0, 20, 40, 60, 80, 100)
      mbreaks2 <- c(0, 10, 20, 30, 40, 50)
      ...
      ###KCM Changed scale and color 9/21/23  
    }else if(input$var == "Iron"){
      mbreaks1 <- c(0, 0.025, 0.050, 0.100, 0.300, 1.0, 18.0)
      ...
      mbreaks <- c(0, 0.010, 0.025, 0.050, 0.100, 3.0)
      
      clrs <- rev(brewer.pal(length(mbreaks), "RdYlGn"))
      pal <- colorBin(palette = clrs, domain = fill.vals, bins = mbreaks)
      
      ###KCM Changed scale 9/21/23 &AEJ on 1/15/2024
    }else if(input$var == "Sulfate"){
      mbreaks1 <- c(0, 5, 10, 20, 30, 40, 60, 80, 100)
      mbreaks2 <- c(0, 5, 10, 15, 20)
      ...
      mbreaks1 <- c(0, 5, 10, 15, 20, 25, 30, 35, 40, 60, 80)
      ...
      mbreaks <- c(0, 5, 10, 15, 20, 25, 30, 35, 40)
      
      clrs <- rev(brewer.pal(length(mbreaks), "PuOr"))
      pal <- colorBin(palette = clrs, domain = fill.vals, bins = mbreaks)
      
    }else if(input$var == "Sodium"){
      mbreaks1 <- c(0, 25, 50, 75, 100, 125, 150)
      mbreaks2 <- c(0, 5, 10, 15, 20, 25)
      ...
      ###KCM Changed from max.value to 1200 because of legend issues with low levels
    }else { # input$var == "Hardness"
      mbreaks1 <- c(0, 100, 150, 200, 250, 300, 350, 400, 450, 500, 1200)
      ...
      if (input$var == "Nitrate"){
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Calcium (standard units)</strong>",
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Iron (standard units)</strong>",
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Manganese (standard units)</strong>",
                                     "<br>Average: ", round(shape@data$Manganese,1),
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Phosphorous (standard units)</strong>",
                                     "<br>Average: ", round(shape@data$P,1),
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Sulfate (standard units)</strong>",
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Potassium (standard units)</strong>",
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Magnesium (standard units)</strong>",
        ...
        proxy %>%
          ...
          addPolygons(data = shape,
                      ...
                      fillColor = ~pal2(fill.vals), fillOpacity = 0.9,
                      popup = paste0(shape@data$Municipality,
                                     "<br><strong>Sodium (standard units)</strong>",
  ...
  output$select_analyte <- renderPlotly({
    ...
    #Subsetting
    if(input$year_muni == "2022") {
      df3 <- df[df$YEAR == 2022,]
    }else if(input$year_muni == "2023") {
      df3 <- df[df$YEAR == 2023,]
    }else{
      df3 <- df[df$YEAR == 2022 | df$YEAR == 2023,]
    }
  ...
  output$county_analyte <- renderPlotly({
    ...
    p2 <- {
      ...
      if(input$cty_analyte == "Nitrate"){
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Nitrate)) +
          ...
          geom_hline(yintercept = 10 , linetype = "dashed" , color = "red") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Nitrate-Nitrogen (mg/L)") +
          labs(title="Summary of Countywide Nitrate-Nitrogen Concentrations")
        
        
      }else if (input$cty_analyte == "Alkalinity") {
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Alkalinity)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Chloride)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Total.Hardness)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Conductivity)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Arsenic)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Calcium)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Iron)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Manganese)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = P)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Sulfate)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Potassium)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Magnesium)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = Sodium)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = factor(YEAR_COMBINED), y = pH)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
    ...
    t1 <- {
      ...
      if(input$trend_analyte == "Nitrate"){
        ...
        ggplot(df4, aes(x = reorder(PROJECT_ID, -Nitrate_mean), y = YEAR)) +
          ...
          ylab("Year") +
          scale_y_continuous(breaks = seq(2022,2023,1)) +
...
##Start of county summary table
  output$cty_summary_table <- renderRHandsontable({
    ...
    if(input$cty_year == "2022") {
      df4 <- df[df$YEAR == 2022,]
    }else if(input$cty_year == "2023") {
      df4 <- df[df$YEAR == 2023,]
    }else{
      df4 <- df[df$YEAR == 2022 | df$YEAR == 2023,]
    }
    ...
    output$wl_AG_CAT <- renderPlotly({
      ...
      if(input$wl_analyte == "Nitrate"){
        WL1 <- { 
                ...
                ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Nitrate)) +
                  geom_boxplot() +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Chloride)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Total.Hardness)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
            ...
            geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
            xlab("") +
            theme(axis.text.x = element_text(angle = 0, hjust = 0.09), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Alkalinity)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Conductivity)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Arsenic)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Calcium)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Iron)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Manganese)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = P)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Sulfate)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Potassium)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Magnesium)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Sodium)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = pH)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
      ...
      if(input$wl_analyte == "Nitrate"){
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Arsenic)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Arsenic (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Calcium)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Calcium (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Manganese)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Manganese (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Iron)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Iron (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = P)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Phosphorus (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Sulfate)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Sulfate (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Potassium)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Potassium (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Magnesium)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Magnesium (mg/L) by Soil Drainage Classification (500 m buffer)")
        ...
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR_COMBINED), y = Sodium)) +
            ...
            theme(axis.text.x = element_text(angle = 0, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Sodium (mg/L) by Soil Drainage Classification (500 m buffer)")
      ...
      if(input$wl_analyte == "Nitrate"){
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Arsenic, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Arsenic (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Calcium, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Calcium (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Iron, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Iron (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Manganese, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Manganese (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = P, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Phosphorus (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Sulfate, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Sulfate (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Potassium, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Potassium (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Magnesium, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Magnesium (mg/L) by Bedrock Type")
        ...
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Sodium, fill = factor(YEAR))) +
            ...
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
            labs(title="Sodium (mg/L) by Bedrock Type")

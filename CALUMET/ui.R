...
ui = fluidPage(
    ...
    titlePanel(strong('Calumet County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Calumet County")),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Calumet County has sampled wells over time 
                              ...
                              The well network is intended to be representative of Calumet County (i.e. accounting for 
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Alkalinity",
                                         ...
                                         p("Alkalinity is a measure of water's ability to neutralize acids.  Alkalinity is associated with carbonate 
                                          ...
                                          carbonate aquifers which occur in parts of Calumet County."),
                                         br(),
                                         ...
                                         p("Because alkalinity is related to the rocks and soils that water flows through on its way to a 
                                          ...
                                          on well water quality on an individual well, or make sense of broader water quality results from Calumet County. 
                                ...
                                tabPanel("Total Hardness",
                                         ...
                                         p("Water with a total hardness concentration less than 150 mg/L is considered soft.  Water with too little hardness
                                          ...
                                          plumbing system. Please note: Total Hardness values less than 50 would be rare for Calumet County, if your water reported less than 50 mg/L of Total 

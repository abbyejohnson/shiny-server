                ...
                fluidRow(
                  ...
                  column(3,
                         ...
                         selectInput("year", "Year",
                                     c("2023 (Year 1)" = "2023"), selected = "2023")),
                  column(5,
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Jefferson County is conducting a project to gather information on well water quality. 
                              The water quality data collected is intended to understand whether groundwater quality is changing over time."),
                              tags$ul
                                      (tags$li("2023 - 828 well owners participated in Year 1"),
                                      #tags$li("2023 - X well owners participated in Year 2")
                                        ),
                                ...
                                tabPanel("Bedrock Type",
                                         ...
                                         tags$ul(
                                           tags$li("Dolomite (red) - A type of carbonate rock that is generally associated with higher concentrations 
                                                   ...
                                                   this bedrock type."),
                                           tags$li("Sandstone (Jefferson) - A type of sedimentary rock formed when sand from oceans or seas were cemented together.

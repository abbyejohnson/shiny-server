      ...
      sidebarPanel(width = 6, 
                   ...
                   tabPanel("Conclusions and Recommendations",
                          ...
                          p("Regarding recommendations for well water testing, rural residences served by private wells are 
                            ...
                            Given the prevalence of arsenic in Jefferson County, all private well owners should be encouraged to test for arsenic at least once, 
                            and more frequently if levels are elevated. Chloride and conductivity 
                            are also good indicators of changes in water quality and provide valuable insight into trends when 
                            sampled routinely. If water treatment is being used to reduce levels of health-related contaminants,
                            homeowners should test treated water occassionally to ensure
                            removal efficiency is adequate to bring contaminants down to safe levels."), 
                          br(),
                          ...
                          chloride trends. The results presented here represent an initial baseline that could be used as a starting
                            ...
                            water quality parameters such as nitrate and chloride. If interested in pursuing testing for an expanded list 
                            of compounds, elevated nitrate and chloride serve as an indicator of land-use impacts. Data from 
                            this work could be used to select wells for which additional testing for emerging contaminants such as PFAS
                            and or pesticides would be most beneficial (i.e. prioritizing testing of wells that are known to be impacted by 
                            land use). While grants and funding may be available to support testing of emerging contaminants, it is 
                            important to be strategic with resources. When resources are not availalbe and/or the risk of detecting certain 
                            contaminants is low, homeowners interested in pursuing additional testing may need to be directed to alternative testing options."),
                          br(),

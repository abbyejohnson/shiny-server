    ...
    leaflet() %>% 
      addTiles(urlTemplate = 'https://tiles.stadiamaps.com/tiles/{variant}/{z}/{x}/{y}{r}.png?api_key={apikey}',
               attribution = paste('&copy; <a href="https://www.stadiamaps.com/" target="_blank">Stadia Maps</a> ' ,
                       ...
                       options = tileOptions(minZoom = 5, maxZoom = 15, variant='stamen_toner_lite', apikey = '21849f37-b13a-4111-8858-95d6d8902aeb')) %>% 
    ...
    if (input$type == "Individual Wells")  {
      ...
      if (input$var == "Nitrate"){
        ...
        proxy %>%
          ...
          #addLegend("bottomleft", pal = factpal, values = ~MapUnit, title = "Quaternary Geology Type", opacity = 1)
    ...
    p1 <- {
      ...
      if(input$analyte == "Nitrate"){
        ggplot(df3, aes(x = TOWNSHIP, y = Nitrate)) +
          ...
          geom_text(aes(2.5,11,label = "Health Standard")) +
          # geom_hline(yintercept = 3.8 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,4.5,label = "State Average")) +
          # geom_hline(yintercept = 2.6 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,1.5,label = "County Average")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Alkalinity)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 195 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,175,label = "State Average")) +
          # geom_hline(yintercept = 356 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,375,label = "County Average")) +
          xlab("Town") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Chloride)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0+1, label = ..count..)) +
          # geom_hline(yintercept = 23.8 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,35,label = "State Average")) +
          # geom_hline(yintercept = 41.9 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,55,label = "County Average")) +
          xlab("Town") +
          ylim(0,250) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Chloride (mg/L)") +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Total.Hardness)) +
          ...
          # geom_hline(yintercept = 212 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,225,label = "State Average")) +
          # geom_hline(yintercept = 366 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,375,label = "County Average")) +
          xlab("Town") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Conductivity)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 486 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,400,label = "State Average")) +
          # geom_hline(yintercept = 839 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,900,label = "County Average")) +
          xlab("Town") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Arsenic)) +
          ...
          geom_text(aes(2.5,0.015,label = "Health Standard")) +
          # geom_hline(yintercept = 0.005 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,0.0,label = "State and County Average")) +
          #geom_hline(yintercept = 839 , linetype = "dashed" , color = "blue") +
          #geom_text(aes(1.5,800,label = "County Average")) +
          xlab("Town") +
          ylim(0,0.10) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Arsenic (mg/L)") +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Calcium)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 40.7 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,55,label = "State Average")) +
          # geom_hline(yintercept = 76.7 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,100,label = "County Average")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Iron)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 0.466 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,0.1,label = "State Average")) +
          # geom_hline(yintercept = 0.789 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,1,label = "County Average")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Manganese)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 0.057 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,0.1,label = "State Average")) +
          # geom_hline(yintercept = 0.043 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,0,label = "County Average")) +
          geom_hline(yintercept = 0.30 , linetype = "dashed" , color = "red") +
          geom_text(aes(2.0,0.35,label = "Health Advisory Level")) +
          xlab("Town") +
          ylim(0,1) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Manganese (mg/L)") +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Sulfate)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 29.9 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,10,label = "State Average")) +
          # geom_hline(yintercept = 38 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,50,label = "County Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "green") +
          xlab("Town") +
          #ylim(0,0.10) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Potassium)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 2.4 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,5,label = "State Average")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Magnesium)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 20.1 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,30,label = "State Average")) +
          # geom_hline(yintercept = 42.4 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,50,label = "County Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "green") +
          xlab("Town") +
          #ylim(0,0.10) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Sodium)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          # geom_hline(yintercept = 41 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,60,label = "State and County Average")) +
          #geom_hline(yintercept = 41.2 , linetype = "dashed" , color = "blue") +
          #geom_text(aes(1.5,60,label = "County Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "green") +
          xlab("Town") +
          #ylim(0,0.10) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = pH)) +
          ...
          # geom_hline(yintercept = 7.04 , linetype = "dashed" , color = "green") +
          # geom_text(aes(2.5,7.5,label = "State Average")) +
          # geom_hline(yintercept = 8.2 , linetype = "dashed" , color = "blue") +
          # geom_text(aes(1.5,8.5,label = "County Average")) +
          xlab("Town") +
          ylim(6,9) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
    ...
    p2 <- {
      ...
      if(input$cty_analyte == "Nitrate"){
        ggplot(df, aes(x = factor(YEAR), y = Nitrate)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 10 , linetype = "dashed" , color = "red") +
          geom_text(aes(0.5,11,label = "Health Standard")) +
          geom_hline(yintercept = 3.8 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,4.5,label = "State Average")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Nitrate-Nitrogen (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Alkalinity)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 195 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.7,175,label = "State Average")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Alkalinity (mg/L as CaCO3)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Chloride)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 23.8 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,45,label = "State Average")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Chloride (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Total.Hardness)) +
          ...
          geom_hline(yintercept = 150 , linetype = "dashed" , color = "green") +
          geom_hline(yintercept = 200 , linetype = "dashed" , color = "purple") +
          geom_hline(yintercept = 212 , linetype = "dashed" , color = "blue") +
          geom_text(aes(0.7,235,label = "State Average")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Total Hardness (mg/L as CaCO3)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Conductivity)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 486 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,550,label = "State Average")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Conductivity (umhos/cm)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Arsenic)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "red") +
          geom_text(aes(0.5,0.015,label = "Health Standard")) +
          geom_hline(yintercept = 0.005 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,0,label = "State Average")) +
          xlab("Year") +
          ylim(0,0.10) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Arsenic (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Calcium)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 40.7 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,55,label = "State Average")) +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Iron)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 0.466 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,0.5,label = "State Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "grey") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Iron (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Manganese)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 0.057 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.6,-0.2,label = "State Average")) +
          geom_hline(yintercept = 0.3 , linetype = "dashed" , color = "red") +
          geom_text(aes(0.6,0.4,label = "Health Advisory Level")) +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Manganese (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Sulfate)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 29.9 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,40,label = "State Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "grey") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Sulfate (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Potassium)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 2.4 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,4,label = "State Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "grey") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Potassium (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Magnesium)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 20.1 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,25,label = "State Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "grey") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Magnesium (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = Sodium)) +
          ...
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
          geom_hline(yintercept = 40.9 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,50,label = "State Average")) +
          #geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "grey") +
          xlab("Year") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Sodium (mg/L)") +
        ...
        ggplot(df, aes(x = factor(YEAR), y = pH)) +
          ...
          geom_hline(yintercept = 7 , linetype = "dashed" , color = "grey") +
          geom_hline(yintercept = 7.04 , linetype = "dashed" , color = "green") +
          geom_text(aes(0.5,7.1,label = "State Average")) +
          xlab("Year") +
          ylim(6,9) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("pH (Standard Units)") +
  ...
  output$well_nitrate <- renderPlotly({
    ...
    w1 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Nitrate)) +
        ...
        ylim(0,max(df2$Nitrate)+11) +
        geom_hline(yintercept = 10 , linetype = "dashed" , color = "red") +
        geom_text(aes(YEAR,11,label = "Health Standard is 10 mg/L")) +
        geom_hline(yintercept = 2.6 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,3.5,label = "County Average")) +
  ...
  output$well_chloride <- renderPlotly({
    ...
    w2 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Chloride)) +
        geom_point(size = 3, color = "black") +
        geom_line(color = "blue") +
        geom_hline(yintercept = 42.0 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,45,label = "County Average")) +
        ylim(0.0,max(df2$Chloride)+50) +
  ...
  output$well_alkalinity <- renderPlotly({
    ...
    w3 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Alkalinity)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 356 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,390,label = "County Average")) +
        ylim(0,550) +
        xlab("Year") +
        theme(axis.title.x = element_blank()) +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
  ...
  output$well_conductivity <- renderPlotly({
    ...
    w4 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Conductivity)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 839 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,849,label = "County Average")) +
        #ylim(min(df2$Conductivity)-50,900) +
        theme(axis.title.x = element_blank()) +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
        ylab("umhos/cm") +
  ...
  output$well_hardness <- renderPlotly({
    ...
    w5 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Total.Hardness)) +
        geom_point(size = 3, color = "black") +
        geom_line(color = "blue") +
        geom_hline(yintercept = 415 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,420,label = "County Average")) +
  ...
  output$well_ph <- renderPlotly({
    ...
    w6 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = pH)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 8.2 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,8.5,label = "County Average")) +
        ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Arsenic <- renderPlotly({
    ...
    w7 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Arsenic)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 0.01 , linetype = "dashed" , color = "red") +
        geom_text(aes(YEAR,0.0105,label = "Health Standard")) +
        geom_hline(yintercept = 0.007 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,0.005,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Calcium <- renderPlotly({
    ...
    w8 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Calcium)) +
        geom_point(size = 3, color = "black") +
        geom_line(color = "blue") +
        geom_hline(yintercept = 86.9 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,89,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Iron <- renderPlotly({
    ...
    w9 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Iron)) +
        ...
        geom_text(aes(YEAR,0.975,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Manganese <- renderPlotly({
    ...
    w10 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Manganese)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 0.3 , linetype = "dashed" , color = "red") +
        geom_text(aes(YEAR,0.325,label = "Health Advisory Level")) +
        geom_hline(yintercept = 0.049 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,0.06,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Phosphorus <- renderPlotly({
    ...
    w11 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = P)) +
        geom_point(size = 3, color = "black") +
        geom_line(color = "blue") +
        geom_hline(yintercept = 0.012 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,0.0123,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Sulfate <- renderPlotly({
    ...
    w12 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Sulfate)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 38 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,38.5,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Potassium <- renderPlotly({
    ...
    w13 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Potassium)) +
        ...
        geom_line(color = "blue") +
        geom_hline(yintercept = 1.9 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,1.95,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Magnesium <- renderPlotly({
    ...
    w14 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Magnesium)) +
        geom_point(size = 3, color = "black") +
        geom_line(color = "blue") +
        geom_hline(yintercept = 48.1 , linetype = "dashed" , color = "blue") +
        geom_text(aes(YEAR,48.25,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
  ...
  output$well_Sodium <- renderPlotly({
    ...
    w15 <- { 
      ...
      ggplot(df2, aes(x = YEAR, y = Sodium)) +
        ...
        geom_text(aes(YEAR,19.5,label = "County Average")) +
        #ylim(6,9) +
        xlab("Year") +
        scale_x_continuous(breaks = seq(min(df2$YEAR), max(df2$YEAR), by = 1)) +
        theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
...
##Start of county summary table
  output$cty_summary_table <- renderRHandsontable({
    ...
    table1 <- st(df4, vars = c("Nitrate","Alkalinity","pH","Conductivity","THard","Chloride","Arsenic","Calcium",
      ...
      if(input$wl_analyte == "Nitrate"){
        WL2 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Nitrate, fill = factor(YEAR))) +
            ...
            geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..)) +
            geom_hline(yintercept = 10 , linetype = "dashed" , color = "red") +
            #geom_text(aes(2.5,11,label = "State Health Standard")) +
            xlab("") +
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.5, face="bold")) +
            ylab("") +
      ...
      if(input$wl_analyte == "Nitrate"){
        WL4 <- { 
          ...
          ggplot(df6, aes(x = factor(YEAR), y = Nitrate, fill = factor(YEAR))) +
            ...
            #geom_text(aes(2.5,11,label = "State Health Standard")) +
            xlab("") +
            theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.title = element_text(size = 11.0, face="bold")) +
            ylab("") +

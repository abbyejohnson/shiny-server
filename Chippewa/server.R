...
server = function(input, output, session) {
  ...
  
  {
    ...
    #   
      ...
      mbreaks <- c(-2, -0.25, -0.1, 0, 0.1, 0.25, 0.50, (max.val+1))
  ...
  output$well_nitrate <- renderPlotly({
    ...
    breaks <- as.numeric(c("2007","2016","2019","2020","2021","2022"))
    w1 <- { 

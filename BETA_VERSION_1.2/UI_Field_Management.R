        ...
        fluidRow(
          box(title = "Nitrogen Budget: Field Management",
              ...
              p("Field Management: When using the Nitrate Leaching Calculator to simulate field management, 
                the calculator allows for comparison of two management scenarios.
                By entering acreage it allows you to estimates a field based flow-weighted mean
                nitrate concentration relative to the proportion of each management scenario on a field and the 
              ...
              box(title = "Precipitation",
                  ...
                  column(6,
                         ...
                         tippy::tippy_this(elementId = "info_inchesPre",
                                           tooltip = "<span style='font-size:16px;'>Enter the annual precipitation if known, 32 inches is the default value for Wisconsin<span>",
                                           placement = "right")
                  )
              ),

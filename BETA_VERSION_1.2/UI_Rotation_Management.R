...
diagram2 <- tags$a(href='https://acsess.onlinelibrary.wiley.com/doi/pdfdirect/10.2136/1991.managingnitrogen.c5',
                   tags$img(src='rotation_management.png', height = '350', width = '625', align = 'center'))
          ...
          box(title = "Ouputs",
              ...
              column(8,
                     box(title = "Crop Information",
                         ...
                         status = "info",
                         width = 12,
                         rHandsontableOutput("rhot1_RM")),
                     box(title = "Inputs",
                         solidHeader = T,
                         status = "info",
                         width = 12,
                         rHandsontableOutput("rhot2_RM")),
                     box(title = "Outputs",
                         solidHeader = T,
                         status = "info",
                         width = 12,
                         rHandsontableOutput("rhot3_RM")),
                     box(title = "Change in N Storage",
                         solidHeader = T,
                         status = "info",
                         width = 12,
                         rHandsontableOutput("rhot4_RM")),
                     box(title = "Cover Crop Residue",
                         solidHeader = T,
                         status = "info",
                         width = 12,
                         rHandsontableOutput("rhot5_RM"))
              ...
              column(4,
                     box(title = "Final Outputs of some sorts",
                         ...
                         box(title = "Year 1",
                             ...
                             column(4,
                                    h4(uiOutput("Yr1_OP_TLN")),
                                    h4(uiOutput("Yr1_OP_FWN"))
                         )
                         ),
                         box(title = "Year 2",
                             width = 12,
                             ...
                             column(8,
                                    ...
                                    h4("Field-Weighted Nitrate-N (mg/L)")),
                             column(4,
                                    h4(uiOutput("Yr2_OP_TLN")),
                                    h4(uiOutput("Yr2_OP_FWN"))
                             )
                         ),
                         box(title = "Year 3",
                             width = 12,
                             ...
                             column(8,
                                    ...
                                    h4("Field-Weighted Nitrate-N (mg/L)")),
                             column(4,
                                    h4(uiOutput("Yr3_OP_TLN")),
                                    h4(uiOutput("Yr3_OP_FWN"))
                             )
                         ),
                         box(title = "Year 4",
                             width = 12,
                             ...
                             column(8,
                                    ...
                                    h4("Field-Weighted Nitrate-N (mg/L)")),
                             column(4,
                                    h4(uiOutput("Yr4_OP_TLN")),
                                    h4(uiOutput("Yr4_OP_FWN"))
                             )
                         ),
                         box(title = "4 Year Running Average",
                             width = 12,
                             solidHeader = T,
                             status = "info",
                             column(8,
                                    h4("Average Leachable N (lb/acre)")),

                             column(4,
                                    h4(uiOutput("Avg_OP_value1")),
                             )
                         ),
                     )
              )

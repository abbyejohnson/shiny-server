...
output$OP_value1_yr1 <- renderUI({
  ...
  total_change_N_yr1 <- input$inoN_RM_yr1 + input$Change_orgN_RM_yr1
...
output$OP_value2 <- renderUI({
  {
    # Getting Input Value for final caclulation
    if (input$irr == 1){
...
output$OP_value6 <- renderUI({
  {
    ...
    totalLeachableN <- (LeachableN1 * input$acres1)  / (input$acres1)
...
output$rhot1_yr4 <- renderRHandsontable({
...
output$rhot2_yr4 <- renderRHandsontable({
...
output$rhot3_yr4 <- renderRHandsontable({
...
output$rhot4_yr4 <- renderRHandsontable({
  
  total_change_N_yr1 <- input$inoN_RM_yr1 + input$Change_orgN_RM_yr1
  total_change_N_yr2 <- input$inoN_RM_yr2 + input$Change_orgN_RM_yr2
  total_change_N_yr3 <- input$inoN_RM_yr3 + input$Change_orgN_RM_yr3
  total_change_N_yr4 <- input$inoN_RM_yr4 + input$Change_orgN_RM_yr4
  
  cop_info <- matrix(c("Year 1", input$inoN_RM_yr1, input$Change_orgN_RM_yr1, total_change_N_yr1,
                       "Year 2", input$inoN_RM_yr2, input$Change_orgN_RM_yr2, total_change_N_yr2,
                       "Year 3", input$inoN_RM_yr3, input$Change_orgN_RM_yr3, total_change_N_yr3,
                       "Year 4", input$inoN_RM_yr4, input$Change_orgN_RM_yr4, total_change_N_yr4), 
                     nrow = 4, ncol = 4, 
...
output$rhot5_yr4 <- renderRHandsontable({
  if(input$cp_yr1 == 0){
    cct_yr1 <- 0
    c_units_yr1 <- 0
    ccy_yr1 <- 0

...
ui = fluidPage(
    ...
    titlePanel(strong('Marathon County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                fluidRow(
                  ...
                  column(3,
                         ...
                         selectInput("year", "Year",
                                     c("2023 & 2024 (Combined)" = "2023&2024"),
                                       selected = "2023&2024")),
                  column(5,
        ...
        ####Removed only 1yr data     "Nitrate Variability" = "Nitrate_sd",
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Marathon County")),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Marathon County is conducting a project to gather information on well water quality. 
                              The water quality data collected is intended to understand whether groundwater quality is changing over time."),
                              tags$ul
                                      (tags$li("2023 & 2024 - 1001 well owners participated"),
                                       #tags$li("2024 - 759 well owners participated")
                                        ),
                              ...
                              The well network is intended to be representative of Marathon County (i.e. accounting for 
                              ...
                              p("Other attributes associated with the well construction or land use can be useful for 
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Alkalinity",
                                         ...
                                         p("Alkalinity is a measure of water's ability to neutralize acids.  Alkalinity is associated with carbonate 
                                          ...
                                          carbonate aquifers which occur in parts of Marathon County."),
                                         br(),
                                         ...
                                         p("Because alkalinity is related to the rocks and soils that water flows through on its way to a 
                                          ...
                                          on well water quality on an individual well, or make sense of broader water quality results from Marathon County. 
                                ...
                                tabPanel("Total Hardness",
                                         ...
                                         p("Water with a total hardness concentration less than 150 mg/L is considered soft.  Water with too little hardness
                                          ...
                                          plumbing system. Please note: Total Hardness values less than 50 would be rare for Marathon County, if your water reported less than 50 mg/L of Total 
                                ...
                                tabPanel("Arsenic",
                                         ...
                                         p("Arsenic is a naturally occurring element that can be found at levels of concern when groundwater dissolves arsenic
                                           containing mineral deposits in the soil and bedrock of some aquifers."),
                                         br(),
                                         ...
                                         p("One way to reduce arsenic is to install a water treatment device capable of reducing arsenic levels; 
                                          testing is the only way to make sure these devices are properly functioning"),
                                         br(),
                                ...
                                tabPanel("Phosphorus",
                                         ...
                                         p("Phosphorus is naturally occurring at low levels in groundwater. It is an essential nutrient for plants and can contribute to eutrophication (excessive aquatic plant/algae growth) in lakes and rivers."),
                                         br(),
                     ...
                     #            ),
                                tabPanel("Individual Wells",  
                                         ...
                                         p("One of the major goals of the project is to understand baseline well water quality spatially in Marathon County.  
                                          By sampling many wells at the same time, we can better understand what water quality parameters are a concern and how they vary throughout the county.
                                           Investigating the relationship of well water quality to various factors can also help us understand what factors contribute to variability in well water quality of Marathon County."),
                                         br(),
                                ...
                                tabPanel("Municipality",
                                         ...
                                         selectInput("year_muni",
                                                     "Select Year:",
                                                     choices = c("2023 & 2024 (Combined)" = "2023&2024"),
                                                     selected = "2023&2024",
                                                     width = 300
                                         ),
                                         br(),
                                ...
                                tabPanel("Wells, Geology, & Land Cover",
                                         ...
                                         p("The following figures allow you to investigate well water quality grouped by different
                                           ...
                                           For instance, land cover categories might be important for nitrate while quaternary geology could be important for hardness and alkalinity.
                                ...
                                tabPanel("County Summary Statistics",
                                         ...
                                         of the 2023-2024 monitoring efforts: "),
                                         ...
                                         p("Select an analyte to see summary statistics for all wells tested during the Marathon County sampling. 

...
server = function(input, output, session) {
  ...
  
  {
    if(input$year == "2025") {
      df1 <- df[df$YEAR == 2025,]
      #munidf <- munidf[munidf$YEAR == 2023 | munidf$YEAR == 2024,]
    ...
    if(input$var == "Alkalinity"){
      mbreaks <- c(0, 50, 100, 150, 200, 250, 300, 350, 400)
      ...
      mbreaks1 <- c(0, 10, 20, 50, 100, 200, 300, 400, 500, max.val)
    ...
    #   
      ...
      mbreaks <- c(0, 6.5, 7.0, 7.5, 8.0, 8.5, 9.0, 9.5)
    ...
    p1 <- {
      ...
      if(input$analyte == "Nitrate"){
        ggplot(df3, aes(x = TOWNSHIP, y = Nitrate)) +
          ...
          geom_text(stat = "count", aes(y = (..count..)*0-1, label = ..count..), size = 2) +
          geom_hline(yintercept = 10 , linetype = "dashed" , color = "red") +
          scale_fill_manual(values=c("black","blue")) +
          xlab("Municipality") +
          theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 6), axis.title = element_text(size = 11, face="bold")) +
          ylab("Nitrate-Nitrogen (mg/L)") +
          labs(title="Summary of Nitrate-Nitrogen Concentration by Municipality")
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Alkalinity)) +
          ...
          labs(title="Summary of Alkalinity Concentration by Municipality")
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Chloride)) +
          ...
          xlab("Municipality") +
          ylim(0,250) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 6), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("Chloride (mg/L)") +
          labs(title="Summary of Chloride Concentration by Municipality")
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Total.Hardness)) +
          ...
          labs(title="Summary of TOtal Hardness Concentration by Municipality")
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = Conductivity)) +
          ...
          labs(title="Summary of Conductivity Concentration by Municipality")
        ...
        ggplot(df3, aes(x = TOWNSHIP, y = pH)) +
          ...
          stat_summary(fun=mean, colour="blue", geom="point", 
                       shape=5, size=2) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
          geom_text(stat = "count", aes(y = (..count..)*0+6, label = ..count..), size = 2) +
          geom_hline(yintercept = 7 , linetype = "dashed" , color = "grey") +
          xlab("Municipality") +
          ylim(6,9) +
          theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 6), axis.title = element_text(size = 11.5, face="bold")) +
          ylab("pH (Standard Units)") +
          labs(title="Summary of pH Concentration by Municipality")
  ...
  output$county_analyte <- renderPlotly({
    ...
    p2 <- {
      ...
      if(input$cty_analyte == "Nitrate"){
        ggplot(df, aes(x = "2025", y = Nitrate)) +
        ...
        ggplot(df, aes(x = "2025", y = Alkalinity)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = "2025", y = Chloride)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = "2025", y = Total.Hardness)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = "2025", y = Conductivity)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
        ...
        ggplot(df, aes(x = "2023&2024", y = pH)) +
          geom_boxplot() +
          stat_summary(fun=mean, colour="blue", geom="point",
                       shape=18, size=3) +
          #the following line is necessary to label the boxplots with the sample number. count*0-1 tricks geom_text to plotting below the xaxis.
...
##Start of county summary table
  output$cty_summary_table <- renderRHandsontable({
    ...
    df4 <- df#subset(df, YEAR==input$cty_year)
 

    
    labs <- c("Nitrate","Alkalinity","pH","Conductivity","Total Hardness","Chloride")
    table1 <- st(df4, vars = c("Nitrate","Alkalinity","pH","Conductivity","THard","Chloride"), 
    ...
    output$wl_AG_CAT <- renderPlotly({
      ...
      if(input$wl_analyte == "Nitrate"){
        WL1 <- {
                ...
                ggplot(df6, aes(x = "2025", y = Nitrate)) +
                  geom_boxplot() +
        ...
        WL1 <- {
          ...
          ggplot(df6, aes(x = "2025", y = Chloride)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- {
          ...
          ggplot(df6, aes(x = "2025", y = Total.Hardness)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- {
          ...
          ggplot(df6, aes(x = "2025", y = Alkalinity)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
        ...
        WL1 <- {
          ...
          ggplot(df6, aes(x = "2025", y = Conductivity)) +
            geom_boxplot() +
            facet_grid(.~factor(ROWCROP_CAT)) +
            stat_summary(fun=mean, colour="blue", geom="point",
                         shape=18, size=3) +
  ...
  # #Well Casing Category
    #Casing Depth Below the Water Table
  ...
  #   #All Agricultural land category, Percent Hay/Pasture

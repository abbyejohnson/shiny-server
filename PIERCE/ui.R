...
ui = fluidPage(
    ...
    titlePanel(strong('Pierce County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
        ...
        ####Removed only 1yr data     "Nitrate Variability" = "Nitrate_sd",
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Pierce County")),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Pierce County is conducting a project to gather information on well water quality. 
                              The water quality data collected is intended to understand whether groundwater quality is changing over time."),
                              tags$ul
                                      (tags$li("2025 - 353 well owners participated"),
                              ...
                              The well network is intended to be representative of Pierce County (i.e. accounting for 
                     ...
                     #            ),
                                ...
                                tabPanel("County Summary Statistics",
                                         ...
                                         of the 2025 monitoring efforts: "),

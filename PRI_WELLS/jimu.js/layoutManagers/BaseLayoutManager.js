    ...
    */
    ...
    loadOnScreenWidgets: function(appConfig){
      ...
      array.forEach(appConfig.widgetOnScreen.widgets, function(widgetConfig) {
		...
		//**added to prevent initialization on screen for BasemapGallery and Draw because placed on other widgets
		if(widgetConfig.name === 'BasemapGallery' || widgetConfig.name === 'Draw'){
          return;
        }
	...
	//**this is call to create onscreen icon

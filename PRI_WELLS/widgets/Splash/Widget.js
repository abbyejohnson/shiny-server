...
define(['dojo/_base/declare',
  ...
  function(declare, lang, html, on, query, cookie, _WidgetsInTemplateMixin, BaseWidget,
           CheckBox, Extent, SpatialReference, utils, esriLang, LoadingShelter, Deferred) {
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
		...
		this._centerExtent = this.config.splash.centerOnClose;
      ...
      close: function() {
		if (this._centerExtent) {
			//**added to force redraw of map to prevent partial draw bug
			...
			if (configExtent) {
				...
				iExtent = this.map.extent;
			}
			this.map.setExtent(iExtent, true); 
		}

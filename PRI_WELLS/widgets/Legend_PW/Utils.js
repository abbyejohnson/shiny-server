    ...
    array.forEach(jimuLayerInfoArray, function(topLayerInfo) {
      ...
      if(topLayerInfo.getShowLegendOfWebmap()) {
        ...
        if(topLayerInfo.isMapNotesLayerInfo()) {
		  ...
		  //***strip service title to useful parameter title
		  //var layerTitle = topLayerInfo.title.slice(12);
		  var layerTitle = topLayerInfo.title;
		  //var paraTitle = layerTitle.slice(0,layerTitle.lastIndexOf(' - '));
		  var paraTitle = layerTitle.slice(0,layerTitle.indexOf(' - '));
          var layerInfoParam = {

  ...
  function(
    ...
    var clazz = declare([BaseWidget], {
      ...
      startup: function() {
		...
		//**added to force best extent for total state display with true flag
		//then just set homebutton extent to this extent after deferred
		
		this.map.setExtent(initalExtent, true).then(lang.hitch(this, function() {
			this.createHomeDijit({
				map: this.map,

                   ...
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              ...
                              (tags$li("2007 - 800 well owners participated"),
                                ...
                                tags$li("2023 - 221 well owners participated")
                              ),
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Municipality",
                                         ...
                                         selectInput("year_muni",
                                                     "Select Year:",
                                                     choices = c("2007","2016","2019","2020","2021","2022","2023"),
                                                     selected = "2023",
                                                     width = 300
                                         ),
                                         br(),
                                ...
                                tabPanel("Annual Summary Statistics",
                                         ...
                                         of the annual monitoring by selecting an individual year: "),
                                                  selectInput("cty_year",
                                                              "Select Year:",
                                                              choices = c("2023","2022","2021","2020","2019","2016","2007"),
                                                              selected = "2023",
                                                              width = 300
                                                  ),
                                                  br(),

...
ui = fluidPage(
    ...
    titlePanel(strong('Chippewa County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                ...
                div("Center for Watershed Science and Education in partnership with Chippewa County"),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Chippewa County has been a national leader in gathering information on well water quality. Major well water sampling
                              efforts have been conducted in 1985, 2007, and 2016. Beginning in 2019 Chippewa County has been working with
                              the University of Wisconsin - Stevens Point and University of Wisconsin - Madison, Division of Extension
                              to evaluate water quality on a more routine basis. While the number of wells is less than previous years, the goal is to test 
                              these wells annually in order to assess changes in groundwater quality within Chippewa County."),
                              tags$ul
                              (tags$li("2007 - 800 well owners participated"),
                                tags$li("2016 - 744 well owners participated"),
                                tags$li("2019 - 155 well owners participated"),
                                tags$li("2020 - 164 well owners participated"),
                                tags$li("2021 - 151 well owners participated"),
                                tags$li("2022 - 292 well owners participated"),
                                tags$li("2023 - 229 well owners participated"),
                                tags$li("2024 - 189 well owners participated"),
                                tags$li("2025 - 174 well owners participated")
                              ),
                              ...
                              The well network is intended to be representative of Chippewa County (i.e. accounting for 
                              ...
                              p("Individual Wells: When individual wells are selected, this map view allows you to see the water quality
                                  test results for each well that was sampled. The well points are approximate locations in order to protect the privacy of participants. Clicking on the points will provide the water quality
                              ...
                              p("Samples are analyzed for nitrate-nitrogen, chloride, alkalinity, total hardness, pH, and conductivity. Nitrate and
                                chloride are useful for understanding the degree to which groundwater has been affected by human activities. Click on the 'LEARN about tests' tab To learn more about the 
                                specific tests and what they tell us about groundwater."),
                              br(),
                     ...
                     tabPanel("LEARN about Tests",
                          ...
                          various land-use practices."),
                                         ...
                                         p("Nitrate is an important test for determining the safety of well water for drinking. Nitrate is a test that allows us to understand the influence of human activities on well water quality. Because it moves
                          can come from a variety of sources and moves easily through soil, it serves as a useful indicator of certain land-use activities. An annual nitrate test is useful for better understanding whether water quality is getting better, worse, or staying
                          the same with respect to certain land-uses (see Sources)."),
                            ...
                            managed grazing to reduce nitrate losses to groundwater")
                                ...
                                tabPanel("Alkalinity",
                                  ...
                                  carbonate aquifers which occur in parts of Chippewa County."),
                                         br(),
                                  ...
                                  on well water quality on an individual well, or make sense of broader water quality results from Chippewa County. Particularly in wells that are uninfluenced by human activity,
                                  ...
                                  more vulnerable or prone to contamination."),
                                         ...
                                         p("There are no health concerns associated with having alkalinity in water. Alkalinity should be roughly 75-100% of the total hardness value in an unsoftened sample. 
                                ...
                                tabPanel("Total Hardness",
                                  ...
                                  plumbing system. Please note: Total Hardness values less than 50 would be rare for Chippewa County, if your water reported less than 50 mg/L of Total 
                                    ...
                                    with hardness in this range generally don't require additional treatment."),
                                         ...
                                         p("Primarily dissolved carbonate minerals from soil and rock materials. When carbonate minerals dissolve, they
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Nitrate Trends",
                                         ...
                                         p("While nitrate may go up, down, or stay the same;
                                            changes in a similar direction can sometimes indicate a trend. Four years of data are required, and only data since 2019 was used in the determination 
                                            of trends.
                                         ...
                                         p("Other wells may simply go up and down each year because of weather or other factors such as crop rotations. More years of data are required 
                                           in order to analyze for trends. Some trends that we observe in the data may be temporary and could change with more years of data. 
                                         ...
                                         p("When viewing the map of trends for individual wells: Blue circles represent
                                            ...
                                            circle provides an idea of the rate of change observed in that well. A minimum of four years
                                           of data are required to determine if a trend exists. The small black points represent wells that
                                           do not have at least four years of data since 2019."), 
                                         p("Data on individual wells over time can be viewed for each parameter by clicking on the 'EXPLORE Project Data > 'Individual Wells' tab.
                                           If you click on an individual well in the Nitrate Trend map data and obtain the 'Well ID', this number can be entered into the drop down to view the historical data."),
                                )
                              )),
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Municipality",
                                         ...
                                         p("Well water quality can be aggregated and displayed by municipality. Select a parameter 
                                           ...
                                           over the box plot to see values for mean (blue diamond), median, minimum, maximum values."),
                                         ...
                                         selectInput("year_muni",
                                                     "Select Year:",
                                                     choices = c("2007","2016","2019","2020","2021","2022","2023","2024","2025"),
                                                     selected = "2025",
                                                     width = 300
                                         ),
                                         br(),
                                ...
                                tabPanel("Annual Summary Statistics",
                                         ...
                                         of the annual monitoring by selecting an individual year: "),
                                                  selectInput("cty_year",
                                                              "Select Year:",
                                                              choices = c("2025","2024","2023","2022","2021","2020","2019","2016","2007"),
                                                              selected = "2025",
                                                              width = 300
                                                  ),
                                                  br(),

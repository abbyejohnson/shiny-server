...
server = function(input, output, session) {
  ...
  output$well_nitrate <- renderPlotly({
    ...
    breaks <- as.numeric(c("2007","2016","2019","2020","2021","2022","2023"))
    w1 <- { 
    ...
    t1 <- {
      ...
      if(input$trend_analyte == "Nitrate"){
        ...
        ggplot(df4, aes(x = reorder(PROJECT_ID,-Nitrate_mean_2019), y = YEAR)) +
          ...
          ylab("Year") +
          scale_y_continuous(breaks = seq(2019,2023,1))+

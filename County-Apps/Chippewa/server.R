...
server = function(input, output, session) {
  ...
  output$well_nitrate <- renderPlotly({
    ...
    breaks <- as.numeric(c("2007","2016","2019","2020","2021"))
    w1 <- { 
    ...
    t1 <- {
      ...
      if(input$trend_analyte == "Nitrate"){
        ...
        ggplot(df4, aes(x = reorder(PROJECT_ID, -Nitrate_mean), y = YEAR)) +
          ...
          ylab("Year") +
          #scale_y_continuous(breaks = seq(2019,2021,1))
          scale_y_continuous(breaks = c(2007, 2016, 2019, 2020, 2021)) +
        ...
        ggplot(df4, aes(x = reorder(PROJECT_ID, -Alkalinity_mean), y = YEAR)) +
          ...
          ylab("Year") +
          #scale_y_continuous(breaks = seq(2019,2021,1))
          scale_y_continuous(breaks = c(2016, 2019, 2020, 2021)) +

...
ui = fluidPage(
    ...
    titlePanel(strong('Dodge County Well Water Monitoring Project')),
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                  ...
                  column(3,
                         ...
                         selectInput("year", "Year",
                                     c("2024 (Year 5)" = "2024",
                                       ...
                                       "2022 (Year 3)" = "2022",
                                       "2021 (Year 2)" = "2021", 
                                       "2020 (Year 1)" = "2020"), selected = "2024")),
                  column(5,
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Dodge County")),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Dodge County is conducting a five-year project 
                              ...
                              tags$ul
                                      ...
                                      tags$li("2022 - 324 well owners participated in Year 3"),
                                      tags$li("2023 - 300 well owners participated in Year 4"),
                                      tags$li("2024 - 281 well owners participated in Year 5")
                                        ),
                              ...
                              The well network is intended to be representative of Dodge County (i.e. accounting for 
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Alkalinity",
                                         ...
                                         p("Alkalinity is a measure of water's ability to neutralize acids.  Alkalinity is associated with carbonate 
                                          ...
                                          carbonate aquifers which occur in parts of Dodge County."),
                                         br(),
                                         ...
                                         p("Because alkalinity is related to the rocks and soils that water flows through on its way to a 
                                          ...
                                          on well water quality on an individual well, or make sense of broader water quality results from Dodge County. 
                                ...
                                tabPanel("Total Hardness",
                                         ...
                                         p("Water with a total hardness concentration less than 150 mg/L is considered soft.  Water with too little hardness
                                          ...
                                          plumbing system. Please note: Total Hardness values less than 50 would be rare for Dodge County, if your water reported less than 50 mg/L of Total 

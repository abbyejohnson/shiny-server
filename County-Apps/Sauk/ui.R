...
ui = fluidPage(
    ...
    sidebarLayout(
      mainPanel(width = 6, 
                  ...
                  column(3,
                         ...
                         selectInput("year", "Year",
                                     c("2025 (Year 7)" = "2025",
                                       ...
                                       "2021 (Year 3)" = "2021",
                                       "2020 (Year 2)" = "2020",
                                       "2019 (Year 1)" = "2019"), selected = "2025")),
                  column(5,
                ...
                div(logo,uwsp,uwex),
                br(),
                div(strong("Center for Watershed Science and Education in partnership with Sauk County")),
                   ...
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              ...
                              tags$ul
                                      ...
                                      tags$li("2023 - 301 well owners participated in Year 5"),
                                      tags$li("2024 - 266 well owners participated in Year 6"),
                                      tags$li("2025 - 249 well owners participated in Year 7"),
                                        ),
                              ...
                              tabsetPanel(
                                ...
                                tabPanel("Alkalinity",
                                         ...
                                         p("Alkalinity is a measure of water's ability to neutralize acids.  Alkalinity is associated with carbonate 
                                          ...
                                          carbonate aquifers which occur in parts of Sauk County."),
                                         br(),
                                         ...
                                         p("Because alkalinity is related to the rocks and soils that water flows through on its way to a 
                                          ...
                                          on well water quality on an individual well, or make sense of broader water quality results from Sauk County. 
                                ...
                                tabPanel("Total Hardness",
                                         ...
                                         p("Water with a total hardness concentration less than 150 mg/L is considered soft.  Water with too little hardness
                                          ...
                                          plumbing system. Please note: Total Hardness values less than 50 would be rare for Sauk County, if your water reported less than 50 mg/L of Total 
                     ...
                     tabPanel("LEARN about other Variables",
                              tabsetPanel(
                                ...
                                tabPanel("Soil Drainage Rank",
                                         ...
                                         tags$ul(
                                           tags$li("(7) Excessively drained - Water is removed very rapidly. Internal free water occurrence
                                            is very rare or very deep. The soils are often coarse-textured and have very high hydraulic 
                                            conductivity."),
                                           tags$li("(6) Somewhat excessively drained - Water is removed from the soil rapidly. Internal 
                                           ...
                                           tags$li("(5) Well drained - Water is removed from the soil readily but not rapidly. Internal free 
                                           ...
                                           tags$li("(3) Somewhat poorly drained - Water is removed slowly so that the soil is wet at 
                                           ...
                                           tags$li("(2) Poorly drained - Water is removed so slowly that the soil is wet at 
                                           ...
                                           tags$li("(1) Very poorly drained - Water is removed from the soil so slowly that free water 
                                ...
                                tabPanel("Nitrate Trends",
                                         ...
                                         p("While nitrate may go up, down, or stay the same;
                                            ...
                                            Mann-Kendall Trend Test was used to determine if there was a relationship of nitrate
                              ...
                              tabsetPanel(
                                tabPanel("County Trends",
                                         ...
                                         p("Overall trends can be visualized by comparing data from wells tested over multiple years. 
                                            For the purposes of this analysis, only wells that participated in all sampling years are included."), 
                                ...
                                tabPanel("Municipality",
                                         ...
                                         selectInput("year_muni",
                                                     "Select Year:",
                                                     choices = c("2025","2024","2023","2022","2021","2020","2019"),
                                                     selected = "2025",
                                                     width = 300
                                         ),
                                         br(),

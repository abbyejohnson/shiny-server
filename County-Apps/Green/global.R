...
shape <- st_read(dsn = "green_municipal.shp", stringsAsFactors = FALSE)
...
logo <- tags$a(tags$img(src='logo.png',
                        alt = 'Logo for Green County, Wisconsin. The words ‘Green County’ appear in large brown letters with a red square containing a white cross substituting for the letter O.
                        Below, the word ‘Wisconsin’ is written in light teal capital letters, and beneath that is the slogan ‘there’s an art to it.’ in a handwritten script.',
...
soils <- tags$a(tags$img(src='soils.png',
                         alt = 'Map of Green County, Wisconsin, displaying soil drainage classifications for the Green County Well Water Sampling Project.
...
wiscland <- tags$a(tags$img(src='wiscland.png',
                            alt = 'Map of Green County, Wisconsin, showing agricultural land cover classifications for the Green County Well Water Sampling Project.

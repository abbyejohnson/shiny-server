...
ui = fluidPage(
    ...
    titlePanel(strong('Green County Well Water Monitoring Project')),
      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     tabPanel("ABOUT the Project",
                              h4(strong("Overview")),
                              tags$p("Green County is conducting a five-year project 
                              ...
                              tags$ul
                                      ...
                                      tags$li("2023 - 279 well owners participated in Year 5"),
                                      tags$li("2024 - 260 well owners participated in Year 6"),
                                      tags$li("2025 - 248 well owners participated in Year 7"),
                                        ),
                              ...
                              The well network is intended to be representative of Green County (i.e. accounting for 

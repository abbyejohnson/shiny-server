      ...
      sidebarPanel(width = 6, 
                   tabsetPanel(
                     ...
                     tabPanel("Solutions",
                              ...
                              p(strong("Use Winter Salt Wisely")),
                              p(strong("If you have a water softener, make sure it's set correctly")),
                              p(strong("Be a conscientious motorist")),
                              p(strong("Help spread the word")),
                              ),
                     tabPanel("Data",
